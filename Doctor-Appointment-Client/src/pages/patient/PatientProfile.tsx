    ...
    async function load() {
      try {
        const [userRes, profileRes] = await Promise.all([
          ...
          api.get<{ success: boolean; data: { profile: ExtProfile } }>(
    ...
    <div className={styles.pageContainer}>
      ...
      {message && (
        <div
          style={{
            background:
              message.includes("updated") || message.includes("Basic")
                ? "#e8f5e9"
                : "#fde8e8",
            border:
              "2px solid " +
              (message.includes("updated") ? "#2e7d32" : "#c62828"),
            borderRadius: "0.5rem",
        ...
        {editMode === "basic" ? (
          ...
          <>
            <div className={styles.profileInfo}>
              <div>
                <strong>Name:</strong> {String(user?.firstName || "")}{" "}
            ...
            <Button variant="primary" onClick={() => setEditMode("basic")}>
              Edit
            </Button>
          </>
        )}
          ...
          <form className={styles.form} onSubmit={handleMedicalSave}>
            <div className={styles.formGroup}>
              ...
              <input
                ...
                value={e("dateOfBirth")}
                onChange={(ev) =>
                  setForm({ ...form, dateOfBirth: ev.target.value })
                }
              />
            </div>
            <div className={styles.formGroup}>
            ...
            >
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  value={e("bloodGroup")}
                  onChange={(ev) =>
                    setForm({ ...form, bloodGroup: ev.target.value })
                  }
                />
              </div>
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  value={e("height")}
                  onChange={(ev) =>
                    setForm({ ...form, height: ev.target.value })
                  }
                />
              </div>
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  value={e("weight")}
                  onChange={(ev) =>
                    setForm({ ...form, weight: ev.target.value })
                  }
                />
              </div>
            </div>
            <div className={styles.formGroup}>
              ...
              <input
                ...
                value={e("allergies")}
                onChange={(ev) =>
                  setForm({ ...form, allergies: ev.target.value })
                }
              />
            </div>
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Chronic Diseases</label>
              <input
                className={styles.formInput}
                value={e("chronicDiseases")}
                onChange={(ev) =>
                  setForm({ ...form, chronicDiseases: ev.target.value })
                }
              />
            </div>
            ...
            >
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  onChange={(ev) =>
                    setForm({ ...form, emergencyContactName: ev.target.value })
                  }
                />
              </div>
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  onChange={(ev) =>
                    setForm({ ...form, emergencyContactPhone: ev.target.value })
                  }
                />
              </div>
            </div>
            ...
            >
              <div className={styles.formGroup}>
                ...
                <input
                  className={styles.formInput}
                  value={e("insuranceProvider")}
                  onChange={(ev) =>
                    setForm({ ...form, insuranceProvider: ev.target.value })
                  }
                />
              </div>
              <div className={styles.formGroup}>
                <label className={styles.formLabel}>Policy No.</label>
                <input
                  className={styles.formInput}
                  value={e("insurancePolicyNumber")}
                  onChange={(ev) =>
                    setForm({ ...form, insurancePolicyNumber: ev.target.value })
                  }
                />
              </div>
            </div>
