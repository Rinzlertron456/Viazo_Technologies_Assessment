...
export function PatientProfile() {
  ...
  async function handleBasicSave(e: React.FormEvent) {
    ...
    } catch { setMessage('Failed to update'); } finally { setSaving(false); }
  }
      ...
      <div className={styles.profileDetails}>
        ...
        {editMode === 'basic' ? (
          <form className={styles.form} onSubmit={handleBasicSave}>
            ...
            <div className={styles.formGroup}><label className={styles.formLabel}>Phone</label><input className={styles.formInput} value={phone} onChange={(e) => setPhone(e.target.value)} /></div>
